...
InlineCurrentSense current_sense  = InlineCurrentSense(.015, 50.0,22,17,_NC); // this is correct setup with c inverted
...
//   digitalWrite(TRIG, LOW);
  ...
  driver.voltage_power_supply = 15.8;
  driver.init();
  // link driver
...
//   current_sense.skip_align = true;
  ...
  current_sense.gain_a = 1/50.0/0.015;
  current_sense.gain_b = 1/50.0/0.015;
  current_sense.gain_c = -1/50.0/0.015;
