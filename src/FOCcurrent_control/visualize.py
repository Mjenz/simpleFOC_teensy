...
analog_data = np.genfromtxt('src/FOCcurrent_control/test10_PROTO/trial1.csv', delimiter=',', skip_header=1)
...
data = np.genfromtxt('src/FOCcurrent_control/test10_PROTO/trial5.csv', delimiter=',', skip_header=1, dtype=float)
